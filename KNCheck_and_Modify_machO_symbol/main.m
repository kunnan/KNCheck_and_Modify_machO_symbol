...
//
//  Created by devzkn on 28/05/2018.
...
#define FilePath "/Users/devzkn/tmp_64.dylib" //导入的文件位置
...
int main(int argc,const char * argv[]) {
    ...
    if (argv[1] != nil) {
       path  = argv[1] ;
        ...
        path = FilePath;
        printf("采用默认路径；或者您可以使用KNCheck_and_Modify_machO_symbol /Users/devzkn/tmp_64.dylib 进行指定\n");
    }
...
//    lipo -thin arm64  xxxx.dylib -output xxxx_64.dylib
    //    lipo -create ./xxxx_v7.dylib ./xxxx_64.dylib -output ./xxxx.dylib  合并
